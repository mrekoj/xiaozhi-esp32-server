...
export function checkOpusLoaded() {
    try {
        ...
        // Try to use Module.instance first (libopus.js export method)
        ...
        log(`Opus library load failed, please check if libopus.js file exists and is correct: ${err.message}`, 'error');
    }
}
        ...
        opusEncoder = {
            ...
            init: function () {
                try {
                    ...
                    // Set DTX (don't transmit silent frames)
