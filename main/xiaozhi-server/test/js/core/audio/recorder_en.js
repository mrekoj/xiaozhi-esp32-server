...
import { initOpusEncoder } from './opus-codec_en.js?v=0127';
import { getAudioPlayer } from './player_en.js?v=0127';
...
export class AudioRecorder {
    ...
    createScriptProcessor() {
        try {
            ...
            silent.connect(this.audioContext.destination);
            log('ScriptProcessorNode fallback successful', 'warning');
    ...
    async start() {
        ...
        try {
            ...
            const { getWebSocketHandler } = await import('../network/websocket_en.js?v=0127');
            ...
            log('Please record at least 1-2 seconds to ensure enough data is collected', 'info');
            ...
            log('PCM direct recording started', 'success');
            return true;
        } catch (error) {
    ...
    stop() {
        ...
        try {
            ...
            log('PCM direct recording stopped', 'success');
            return true;
        } catch (error) {
